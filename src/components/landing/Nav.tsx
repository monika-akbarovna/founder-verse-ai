    ...
    >
      <nav className="glass-strong relative flex items-center justify-between rounded-full px-5 py-2.5 shadow-elegant">
        ...
        <div className="flex items-center gap-2">
          ...
          <a href="#cta" className="rounded-full bg-gradient-primary px-4 py-1.5 text-xs font-semibold text-primary-foreground shadow-glow-purple transition-transform hover:scale-105">
            Launch
          </a>
        </div>
      </nav>
